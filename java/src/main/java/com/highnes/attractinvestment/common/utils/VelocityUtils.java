...
public class VelocityUtils {
     ...
     * 菜单空间路径
     */
    private static final String TEMPLATES_SQL = "main/resources/menusql";
...
//        templates.add("vm/sql/sql.vm");
    ...
    public static String getFileName(String template, GenTable genTable) {
        ...
        String sqlPath = TEMPLATES_SQL + "/" + moduleName + "/" + businessName;
...
//            fileName = StringUtils.format("{}/{}Menu.sql", sqlPath, businessName);
//        }
        return fileName;
    }
